...
TEST_CASE("integral_constant", "[meta.help]") {
  ...
  /* constexpr operator value_type() const noexcept; */ {
    ...
    CHECK_NOEXCEPT(static_cast<int>(ic));
...
TEST_CASE("aligned_union", "[meta.trans.other]") {
  ...
  // `Types`.
  {
    ...
    CHECK_DECLTYPE(std::size_t const, au0::alignment_value);
    CHECK(au0::alignment_value == alignof(U));
    CHECK_CXX11_CONSTEXPR(member, au0::alignment_value);
  }
}
...
TEST_CASE("is_void_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_void_v<void>);
  CHECK(slb::is_void_v<void> == slb::is_void<void>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_void_v<void>);
}
...
TEST_CASE("is_null_pointer_v", "[meta.unary.cat]") {
  using nullptr_t = decltype(nullptr);
  CHECK_DECLTYPE(bool const, slb::is_null_pointer_v<nullptr_t>);
  CHECK(slb::is_null_pointer_v<nullptr_t> ==
        slb::is_null_pointer<nullptr_t>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_null_pointer_v<nullptr_t>);
}

// template<class T>
//   inline constexpr bool is_integral_v = is_integral<T>::value;
TEST_CASE("is_integral_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_integral_v<int>);
  CHECK(slb::is_integral_v<int> == slb::is_integral<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_integral_v<int>);
}

// template<class T>
//   inline constexpr bool is_floating_point_v = is_floating_point<T>::value;
TEST_CASE("is_floating_point_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_floating_point_v<double>);
  CHECK(slb::is_floating_point_v<double> ==
        slb::is_floating_point<double>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_floating_point_v<double>);
}

// template<class T>
//   inline constexpr bool is_array_v = is_array<T>::value;
TEST_CASE("is_array_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_array_v<int[3]>);
  CHECK(slb::is_array_v<int[3]> == slb::is_array<int[3]>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_array_v<int[3]>);
}

// template<class T>
//   inline constexpr bool is_pointer_v = is_pointer<T>::value;
TEST_CASE("is_pointer_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_pointer_v<int*>);
  CHECK(slb::is_pointer_v<int*> == slb::is_pointer<int*>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_pointer_v<int*>);
}
...
TEST_CASE("is_lvalue_reference_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_lvalue_reference_v<int&>);
  CHECK(slb::is_lvalue_reference_v<int&> ==
        slb::is_lvalue_reference<int&>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_lvalue_reference_v<int&>);
}
...
TEST_CASE("is_rvalue_reference_v", "[meta.unary.cat]") {
  CHECK_DECLTYPE(bool const, slb::is_rvalue_reference_v<int&&>);
  CHECK(slb::is_rvalue_reference_v<int&&> ==
        slb::is_rvalue_reference<int&&>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_rvalue_reference_v<int&&>);
}
...
TEST_CASE("is_member_object_pointer_v", "[meta.unary.cat]") {
  class C {};
  CHECK_DECLTYPE(bool const, slb::is_member_object_pointer_v<int C::*>);
  CHECK(slb::is_member_object_pointer_v<int C::*> ==
        slb::is_member_object_pointer<int C::*>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_member_object_pointer_v<int C::*>);
}
...
TEST_CASE("is_member_function_pointer_v", "[meta.unary.cat]") {
  class C {};
  CHECK_DECLTYPE(bool const, slb::is_member_function_pointer_v<int (C::*)()>);
  CHECK(slb::is_member_function_pointer_v<int (C::*)()> ==
        slb::is_member_function_pointer<int (C::*)()>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_member_function_pointer_v<int (C::*)()>);
}
...
TEST_CASE("is_enum_v", "[meta.unary.cat]") {
  enum E {};
  CHECK_DECLTYPE(bool const, slb::is_enum_v<E>);
  CHECK(slb::is_enum_v<E> == slb::is_enum<E>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_enum_v<E>);
}
...
TEST_CASE("is_union_v", "[meta.unary.cat]") {
  union U {};
  CHECK_DECLTYPE(bool const, slb::is_union_v<U>);
  CHECK(slb::is_union_v<U> == slb::is_union<U>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_union_v<U>);
}
...
TEST_CASE("is_class_v", "[meta.unary.cat]") {
  class C {};
  CHECK_DECLTYPE(bool const, slb::is_class_v<C>);
  CHECK(slb::is_class_v<C> == slb::is_class<C>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_class_v<C>);
}
...
TEST_CASE("is_function_v", "[meta.unary.cat]") {
  {
    CHECK_DECLTYPE(bool const, slb::is_function_v<void()>);
    CHECK(slb::is_function_v<void()> == slb::is_function<void()>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_function_v<void()>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::is_function_v<void() noexcept>);
    CHECK(slb::is_function_v<void() noexcept> ==
          slb::is_function<void() noexcept>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_function_v<void() noexcept>);
  }
}
...
TEST_CASE("is_member_pointer_v", "[meta.unary.comp]") {
  class C {};
  CHECK_DECLTYPE(bool const, slb::is_member_pointer_v<int C::*>);
  CHECK(slb::is_member_pointer_v<int C::*> ==
        slb::is_member_pointer<int C::*>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_member_pointer_v<int C::*>);
}
...
TEST_CASE("is_const_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_const_v<int const>);
  CHECK(slb::is_const_v<int const> == slb::is_const<int const>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_const_v<int const>);
}

// template<class T>
//   inline constexpr bool is_volatile_v = is_volatile<T>::value;
TEST_CASE("is_volatile_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_volatile_v<int volatile>);
  CHECK(slb::is_volatile_v<int volatile> ==
        slb::is_volatile<int volatile>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_volatile_v<int volatile>);
}

// template<class T>
//   inline constexpr bool is_trivial_v = is_trivial<T>::value;
TEST_CASE("is_trivial_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivial_v<int>);
  CHECK(slb::is_trivial_v<int> == slb::is_trivial<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivial_v<int>);
}
...
TEST_CASE("is_trivially_copyable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_copyable_v<int>);
  CHECK(slb::is_trivially_copyable_v<int> ==
        slb::is_trivially_copyable<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_copyable_v<int>);
}
#endif
...
TEST_CASE("is_standard_layout_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_standard_layout_v<int>);
  CHECK(slb::is_standard_layout_v<int> == slb::is_standard_layout<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_standard_layout_v<int>);
}
...
TEST_CASE("is_empty_v", "[meta.unary.prop]") {
  struct Empty {};
  CHECK_DECLTYPE(bool const, slb::is_empty_v<Empty>);
  CHECK(slb::is_empty_v<Empty> == slb::is_empty<Empty>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_empty_v<Empty>);
}
...
TEST_CASE("is_polymorphic_v", "[meta.unary.prop]") {
  ...
  CHECK_DECLTYPE(bool const, slb::is_polymorphic_v<Polymorphic>);
  CHECK(slb::is_polymorphic_v<Polymorphic> ==
        slb::is_polymorphic<Polymorphic>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_polymorphic_v<Polymorphic>);
}
...
TEST_CASE("is_abstract_v", "[meta.unary.prop]") {
  ...
  CHECK_DECLTYPE(bool const, slb::is_abstract_v<Abstract>);
  CHECK(slb::is_abstract_v<Abstract> == slb::is_abstract<Abstract>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_abstract_v<Abstract>);
}
...
TEST_CASE("is_final_v", "[meta.unary.prop]") {
  class Final final {};
  CHECK_DECLTYPE(bool const, slb::is_final_v<Final>);
  CHECK(slb::is_final_v<Final> == slb::is_final<Final>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_final_v<Final>);
}
#endif
...
TEST_CASE("is_aggregate_v", "[meta.unary.prop]") {
  ...
  CHECK_DECLTYPE(bool const, slb::is_aggregate_v<Aggregate>);
  CHECK(slb::is_aggregate_v<Aggregate> == slb::is_aggregate<Aggregate>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_aggregate_v<Aggregate>);
}
#endif
...
TEST_CASE("is_signed_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_signed_v<signed int>);
  CHECK(slb::is_signed_v<signed int> == slb::is_signed<signed int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_signed_v<signed int>);
}

// template<class T>
//   inline constexpr bool is_unsigned_v = is_unsigned<T>::value;
TEST_CASE("is_unsigned_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_unsigned_v<unsigned int>);
  CHECK(slb::is_unsigned_v<unsigned int> ==
        slb::is_unsigned<unsigned int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_unsigned_v<unsigned int>);
}
...
TEST_CASE("is_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_constructible_v<int, int>);
  CHECK(slb::is_constructible_v<int, int> ==
        slb::is_constructible<int, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_constructible_v<int, int>);
}
...
TEST_CASE("is_default_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_default_constructible_v<int>);
  CHECK(slb::is_default_constructible_v<int> ==
        slb::is_default_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_default_constructible_v<int>);
}
...
TEST_CASE("is_copy_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_copy_constructible_v<int>);
  CHECK(slb::is_copy_constructible_v<int> ==
        slb::is_copy_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_copy_constructible_v<int>);
}
...
TEST_CASE("is_trivially_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_constructible_v<int>);
  CHECK(slb::is_trivially_constructible_v<int> ==
        slb::is_trivially_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_constructible_v<int>);
}
...
TEST_CASE("is_trivially_default_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_default_constructible_v<int>);
  CHECK(slb::is_trivially_default_constructible_v<int> ==
        slb::is_trivially_default_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_default_constructible_v<int>);
}
...
TEST_CASE("is_trivially_copy_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_copy_constructible_v<int>);
  CHECK(slb::is_trivially_copy_constructible_v<int> ==
        slb::is_trivially_copy_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_copy_constructible_v<int>);
}
...
TEST_CASE("is_trivially_move_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_move_constructible_v<int>);
  CHECK(slb::is_trivially_move_constructible_v<int> ==
        slb::is_trivially_move_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_move_constructible_v<int>);
}
...
TEST_CASE("is_trivially_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_assignable_v<int&, int>);
  CHECK(slb::is_trivially_assignable_v<int&, int> ==
        slb::is_trivially_assignable<int&, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_assignable_v<int&, int>);
}
...
TEST_CASE("is_trivially_copy_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_copy_assignable_v<int>);
  CHECK(slb::is_trivially_copy_assignable_v<int> ==
        slb::is_trivially_copy_assignable<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_copy_assignable_v<int>);
}
...
TEST_CASE("is_trivially_move_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_move_assignable_v<int>);
  CHECK(slb::is_trivially_move_assignable_v<int> ==
        slb::is_trivially_move_assignable<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_move_assignable_v<int>);
}
...
TEST_CASE("is_trivially_destructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_trivially_destructible_v<int>);
  CHECK(slb::is_trivially_destructible_v<int> ==
        slb::is_trivially_destructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_trivially_destructible_v<int>);
}
...
TEST_CASE("is_nothrow_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_constructible_v<int, int>);
  CHECK(slb::is_nothrow_constructible_v<int, int> ==
        slb::is_nothrow_constructible<int, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_constructible_v<int, int>);
}
...
TEST_CASE("is_nothrow_default_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_default_constructible_v<int>);
  CHECK(slb::is_nothrow_default_constructible_v<int> ==
        slb::is_nothrow_default_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_default_constructible_v<int>);
}
...
TEST_CASE("is_nothrow_copy_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_copy_constructible_v<int>);
  CHECK(slb::is_nothrow_copy_constructible_v<int> ==
        slb::is_nothrow_copy_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_copy_constructible_v<int>);
}
...
TEST_CASE("is_nothrow_move_constructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_move_constructible_v<int>);
  CHECK(slb::is_nothrow_move_constructible_v<int> ==
        slb::is_nothrow_move_constructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_move_constructible_v<int>);
}
...
TEST_CASE("is_nothrow_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_assignable_v<int&, int>);
  CHECK(slb::is_nothrow_assignable_v<int&, int> ==
        slb::is_nothrow_assignable<int&, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_assignable_v<int&, int>);
}
...
TEST_CASE("is_nothrow_copy_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_copy_assignable_v<int>);
  CHECK(slb::is_nothrow_copy_assignable_v<int> ==
        slb::is_nothrow_copy_assignable<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_copy_assignable_v<int>);
}
...
TEST_CASE("is_nothrow_move_assignable_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_move_assignable_v<int>);
  CHECK(slb::is_nothrow_move_assignable_v<int> ==
        slb::is_nothrow_move_assignable<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_move_assignable_v<int>);
}
...
TEST_CASE("is_nothrow_destructible_v", "[meta.unary.prop]") {
  CHECK_DECLTYPE(bool const, slb::is_nothrow_destructible_v<int>);
  CHECK(slb::is_nothrow_destructible_v<int> ==
        slb::is_nothrow_destructible<int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_destructible_v<int>);
}
...
TEST_CASE("has_unique_object_representations_v", "[meta.unary.prop]") {
  ...
  CHECK_DECLTYPE(bool const,
                 slb::has_unique_object_representations_v<
...
TEST_CASE("alignment_of_v", "[meta.unary.prop.query]") {
  CHECK_DECLTYPE(std::size_t const, slb::alignment_of_v<int>);
...
TEST_CASE("rank_v", "[meta.unary.prop.query]") {
  CHECK_DECLTYPE(std::size_t const, slb::rank_v<int[2][2][2]>);
...
TEST_CASE("extent_v", "[meta.unary.prop.query]") {
  CHECK_DECLTYPE(std::size_t const, slb::extent_v<int[2][3]>);
...
TEST_CASE("is_same_v", "[meta.rel]") {
  CHECK_DECLTYPE(bool const, slb::is_same_v<int, int>);
  CHECK(slb::is_same_v<int, int> == slb::is_same<int, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_same_v<int, int>);
}
...
TEST_CASE("is_base_of_v", "[meta.rel]") {
  class Base {};
  class Derived : public Base {};
  CHECK_DECLTYPE(bool const, slb::is_base_of_v<Base, Derived>);
  CHECK(slb::is_base_of_v<Base, Derived> ==
        slb::is_base_of<Base, Derived>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_base_of_v<Base, Derived>);
}

// template<class From, class To>
//   inline constexpr bool is_convertible_v = is_convertible<From, To>::value;
TEST_CASE("is_convertible_v", "[meta.rel]") {
  CHECK_DECLTYPE(bool const, slb::is_convertible_v<float, int>);
  CHECK(slb::is_convertible_v<float, int> ==
        slb::is_convertible<float, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_convertible_v<float, int>);
}
...
TEST_CASE("is_invocable_v", "[meta.rel]") {
  ...
  CHECK_DECLTYPE(bool const, slb::is_invocable_v<F, int>);
  CHECK(slb::is_invocable_v<F, int> == slb::is_invocable<F, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_invocable_v<F, int>);
}
...
TEST_CASE("is_invocable_r_v", "[meta.rel]") {
  ...
  {
    CHECK_DECLTYPE(bool const, slb::is_invocable_r_v<int, F, int>);
    CHECK(slb::is_invocable_r_v<int, F, int> ==
          slb::is_invocable_r<int, F, int>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_invocable_r_v<int, F, int>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::is_invocable_r_v<void, F, int>);
    CHECK(slb::is_invocable_r_v<void, F, int> ==
          slb::is_invocable_r<void, F, int>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_invocable_r_v<void, F, int>);
  }
}
...
TEST_CASE("is_nothrow_invocable_v", "[meta.rel]") {
  ...
  CHECK_DECLTYPE(bool const, slb::is_nothrow_invocable_v<F, int>);
  CHECK(slb::is_nothrow_invocable_v<F, int> ==
        slb::is_nothrow_invocable<F, int>::value);
  CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_invocable_v<F, int>);
}
...
TEST_CASE("is_nothrow_invocable_r_v", "[meta.rel]") {
  ...
  {
    CHECK_DECLTYPE(bool const, slb::is_nothrow_invocable_r_v<int, F, int>);
    CHECK(slb::is_nothrow_invocable_r_v<int, F, int> ==
          slb::is_nothrow_invocable_r<int, F, int>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_invocable_r_v<int, F, int>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::is_nothrow_invocable_r_v<void, F, int>);
    CHECK(slb::is_nothrow_invocable_r_v<void, F, int> ==
          slb::is_nothrow_invocable_r<void, F, int>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::is_nothrow_invocable_r_v<void, F, int>);
  }
}
...
TEST_CASE("conjunction_v", "[meta.logical]") {
  {
    CHECK_DECLTYPE(bool const, slb::conjunction_v<>);
    CHECK(slb::conjunction_v<> == slb::conjunction<>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::conjunction_v<>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::conjunction_v<slb::true_type>);
    CHECK(slb::conjunction_v<slb::true_type> ==
          slb::conjunction<slb::true_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::conjunction_v<slb::true_type>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::conjunction_v<slb::false_type>);
    CHECK(slb::conjunction_v<slb::false_type> ==
          slb::conjunction<slb::false_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::conjunction_v<slb::false_type>);
  }
}
...
TEST_CASE("disjunction_v", "[meta.logical]") {
  {
    CHECK_DECLTYPE(bool const, slb::disjunction_v<>);
    CHECK(slb::disjunction_v<> == slb::disjunction<>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::disjunction_v<>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::disjunction_v<slb::true_type>);
    CHECK(slb::disjunction_v<slb::true_type> ==
          slb::disjunction<slb::true_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::disjunction_v<slb::true_type>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::disjunction_v<slb::false_type>);
    CHECK(slb::disjunction_v<slb::false_type> ==
          slb::disjunction<slb::false_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::disjunction_v<slb::false_type>);
  }
}
...
TEST_CASE("negation_v", "[meta.logical]") {
  {
    CHECK_DECLTYPE(bool const, slb::negation_v<slb::true_type>);
    CHECK(slb::negation_v<slb::true_type> ==
          slb::negation<slb::true_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::negation_v<slb::true_type>);
  }

  {
    CHECK_DECLTYPE(bool const, slb::negation_v<slb::false_type>);
    CHECK(slb::negation_v<slb::false_type> ==
          slb::negation<slb::false_type>::value);
    CHECK_CXX11_CONSTEXPR(v, slb::negation_v<slb::false_type>);
  }
}
